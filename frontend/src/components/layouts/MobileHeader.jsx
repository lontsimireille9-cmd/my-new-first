  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-50 border-b border-line bg-surface/95 shadow-sm backdrop-blur lg:hidden">
      <div className="flex h-14 items-center gap-2 px-3 sm:px-6">
        {showBackButton && (
          <button onClick={onBack} className="mr-3 flex h-9 w-9 items-center justify-center rounded-xl text-ink/70 transition hover:bg-surface-2 hover:text-primary" aria-label={t("back")}>
